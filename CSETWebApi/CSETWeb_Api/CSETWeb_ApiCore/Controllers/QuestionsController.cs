...
namespace CSETWeb_Api.Controllers
{
    public class QuestionsController : ControllerBase
    {
        ...
        [HttpPost, HttpGet]
        [Route("api/Details")]
        public QuestionDetailsContentViewModel GetDetails([FromQuery] int QuestionId, bool IsComponent)
        {
            int assessmentId = Auth.AssessmentForUser();
            string applicationMode = GetApplicationMode(assessmentId);
        ...
        public Finding GetFinding([FromQuery] int Answer_Id, int Finding_id, int Question_Id)
        {
            int assessmentId = Auth.AssessmentForUser();
            using (CSET_Context context = new CSET_Context())
            {
