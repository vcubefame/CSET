...
namespace CSETWeb_Api.Controllers
{
    ...
    public class AnalysisController : ControllerBase
    {
        ...
        public IActionResult GetFeedback()
        {
            ...
            try
            {
                using (CSET_Context context = new CSET_Context())
                {
                    ...
                    bool FaaMail = context.AVAILABLE_STANDARDS.Where(x =>
                                       x.Assessment_Id == assessmentId && x.Selected == true
                                                                       && (x.Set_Name == "FAA_MAINT" ||
                                                                           x.Set_Name == "FAA")).FirstOrDefault() !=
                                   null;
                    ...
                    {
                        q.Question_Text =
                            rm.ResolveParameters(q.question_or_requirement_id, q.answer_id, q.Question_Text);
                        ...
                        FeedbackResult.FeedbackBody += "Question #" + " " + q.mode + ":" +
                                                       q.question_or_requirement_id + ". <br/><br/><br/>";
                    }
                    ...
                    {
                        q.Question_Text =
                            rm.RichTextParameters(q.question_or_requirement_id, q.answer_id, q.Question_Text);
                        ...
                        FeedbackResult.FeedbackEmailBody +=
                            "Question #" + " " + q.mode + ":" + q.question_or_requirement_id + ". %0D%0A%0D%0A%0D%0A";
                    }
        ...
        public IActionResult GetTopCategories([FromQuery] int? total)
        {
            if (total == null)
            {
                total = 10000;
        ...
        public IActionResult GetStandardSummaryOverall()
        {
            ...
            using (CSET_Context context = new CSET_Context())
            {
                return Ok(GetStandardsSummarySingle(context, assessmentId));
            }
        }
        ...
        public IActionResult GetStandardsSummary()
        {
            ...
            using (CSET_Context context = new CSET_Context())
            {
                ...
                {
                    return Ok(GetStandardsSummaryMultiple(context, assessmentId));
                }
                return Ok(GetStandardsSummarySingle(context, assessmentId));
            }
        }
        ...
        public IActionResult GetNetworkWarnings()
        {
            ...
            {
                return Ok((List<NETWORK_WARNINGS>)db.NETWORK_WARNINGS
