...
namespace CSETWeb_Api.Controllers
{
    ...
    public class ModuleBuilderController : ControllerBase
    {
        ...
        public SetDetail GetSetDetail([FromQuery] string setName)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public SetDetail CloneSet([FromQuery] string setName)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public QuestionListResponse GetQuestionsForSet([FromQuery] string setName)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public List<int> GetMyQuestionsUsedByOtherSets([FromQuery] string setName)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public bool IsQuestionInUse([FromQuery] int questionID)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public ModuleResponse GetStandardStructure([FromQuery] string setName)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public Requirement GetRequirement([FromQuery] string setName, [FromQuery] int reqID)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public List<ReferenceDoc> GetReferenceDocs([FromQuery] string setName, [FromQuery] string filter)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public List<ReferenceDoc> GetReferenceDocs([FromQuery] string setName)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public ReferenceDoc GetReferenceDocDetail([FromQuery] int id)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
        ...
        public ReferenceDocLists AddDeleteRefDocToRequirement([FromQuery] int reqId, [FromQuery] int docId, bool isSourceRef, [FromQuery] string bookmark, [FromQuery] bool add)
        {
            ModuleBuilderManager m = new ModuleBuilderManager();
